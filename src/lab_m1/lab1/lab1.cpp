...
void Lab1::Init()
{
    ...
    Mesh* mesh3 = new Mesh("box");
    mesh3->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "primitives"), "box.obj");
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[mes], glm::vec3(x, y, z));

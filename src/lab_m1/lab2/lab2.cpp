...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            ...
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // opposing vertex orientations.
    {
        ...
        vector<unsigned int> indicestsq =
        {
            0, 1, 2,
            0, 3, 2,
        };
        CreateMesh("square", verticessq, indicestsq);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexNormal"], glm::vec3(0, 0, 0));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(3, 0, 0));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(6, 0, 0));
